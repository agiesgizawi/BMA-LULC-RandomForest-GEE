// Original GEE script: https://code.earthengine.google.com/a08ae8fb2944aff93d7e2f2302fbb0f9
// Note: link requires Google authentication; full code provided below for archival purposes

// =========================================================
// LULC Classification 2012 - Bandung Metropolitan Area
...
Map.addLayer(ndvi, {min: -0.2, max: 1, palette: ['red', 'yellow', 'green']}, 'NDVI 2012');
Map.addLayer(ndbi, {min: -1, max: 1, palette: ['blue', 'white', 'red']}, 'NDBI 2012');
Map.addLayer(mndwi, {min: -1, max: 1, palette: ['red', 'white', 'blue']}, 'MNDWI 2012');
Map.addLayer(bsi, {min: -1, max: 1, palette: ['white', 'brown', 'black']}, 'BSI 2012');
...
// ------------------------
var obiaClassified2012 = imageObject.classify(obiaClassifier);
...
Map.addLayer(obiaClassified2012, {
  min: 0,
  max: 4,
...
// ------------------------
// Export the final 2012 classification map
// ------------------------
Export.image.toAsset({
  image: obiaClassified2012,
  description: 'LULC_Map_2012',
  assetId: 'users/agiegizawi/LULC_2012',
  scale: 30,
  region: study_area,
  maxPixels: 1e13
});
...
Export.image.toDrive({
  image: l7compositeMasked,
  description: 'Landsat7_SR_Composite_2012',
  folder: 'GEE_Exports',
  scale: 30,
  region: study_area,
  fileFormat: 'GeoTIFF',
